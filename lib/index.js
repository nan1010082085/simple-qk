...
class UseMicroApp {
  ...
  constructor({
    ...
    this.$name = name;
    this.$routes = routes;
    this.$component = component ? component : () => Promise.resolve().then(function () { return require('./index-b9ebce5d.js'); });
