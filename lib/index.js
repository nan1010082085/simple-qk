...
var _noop__default = /*#__PURE__*/_interopDefaultLegacy(_noop);
...
var _snakeCase__default = /*#__PURE__*/_interopDefaultLegacy(_snakeCase);
...
function getAddOns(global, publicPath) {
  return _mergeWith__default["default"]({}, getAddOn(global), getAddOn$1(global, publicPath), function (v1, v2) {
    return _concat__default["default"](v1 !== null && v1 !== void 0 ? v1 : [], v2 !== null && v2 !== void 0 ? v2 : []);
  });
}
...
function emitGlobal(state, prevState) {
  Object.keys(deps).forEach(function (id) {
    if (deps[id] instanceof Function) {
      deps[id](_cloneDeep__default["default"](state), _cloneDeep__default["default"](prevState));
    }
  });
}
...
function initGlobalState() {
  ...
  if (state === globalState) {
    ...
    var prevGlobalState = _cloneDeep__default["default"](globalState);

    globalState = _cloneDeep__default["default"](state);
...
function getMicroAppStateActions(id, isMaster) {
  return {
    ...
    onGlobalStateChange: function onGlobalStateChange(callback, fireImmediately) {
      ...
      if (fireImmediately) {
        var cloneState = _cloneDeep__default["default"](globalState);
    ...
    setGlobalState: function setGlobalState() {
      ...
      globalState = _cloneDeep__default["default"](Object.keys(state).reduce(function (_globalState, changeKey) {
...
function getWrapperId(id) {
  return "__qiankun_microapp_wrapper_for_".concat(_snakeCase__default["default"](id), "__");
}
...
function validateExportLifecycle(exports) {
  ...
  return _isFunction__default["default"](bootstrap) && _isFunction__default["default"](mount) && _isFunction__default["default"](unmount);
}
...
function manualInvokeElementOnLoad(element) {
  ...
  if (_isFunction__default["default"](element.onload)) {
...
function manualInvokeElementOnError(element) {
  ...
  if (_isFunction__default["default"](element.onerror)) {
...
function patch$2() {
  ...
  var rawHistoryListen = function rawHistoryListen(_) {
    return _noop__default["default"];
  };

  var historyListeners = [];
  var historyUnListens = [];

  if (window.g_history && _isFunction__default["default"](window.g_history.listen)) {
  ...
  return function free() {
    var rebuild = _noop__default["default"];
    /*
...
function createElement(appContent, strictStyleIsolation, scopedCSS, appName) {
  ...
  if (scopedCSS) {
    ...
    _forEach__default["default"](styleNodes, function (stylesheetElement) {
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 16:
            ...
            _mergeWith = _mergeWith__default["default"]({}, getAddOns(global, assetPublicPath), lifeCycles, function (v1, v2) {
              return _concat__default["default"](v1 !== null && v1 !== void 0 ? v1 : [], v2 !== null && v2 !== void 0 ? v2 : []);
...
function doPrefetchStrategy(apps, prefetchStrategy, importEntryOpts) {
  ...
  } else if (_isFunction__default["default"](prefetchStrategy)) {
    (function () {
...
function registerMicroApps(apps, lifeCycles) {
  ...
  unregisteredApps.forEach(function (app) {
    var name = app.name,
        ...
        loader = _app$loader === void 0 ? _noop__default["default"] : _app$loader,
        props = app.props,
...
class UseMicroApp {
  ...
  constructor({
    ...
    this.$name = name;
    this.$routes = routes;
    this.$component = component ? component : () => Promise.resolve().then(function () { return require('./index-2fa95ce1.js'); });
