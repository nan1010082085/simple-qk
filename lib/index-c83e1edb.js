...
var index$1 = require('./index-35ec5066.js');
...
function set (target, key, val) {
  if (process.env.NODE_ENV !== 'production' &&
    (isUndef(target) || isPrimitive$1(target))
  ) {
...
function _createElement (
  ...
  if (process.env.NODE_ENV !== 'production' &&
    isDef(data) && isDef(data.key) && !isPrimitive$1(data.key)
  ) {
    {
      warn$1(
...
Container = index$1.__decorate([Component({
  name: 'Container'
})], Container);
var Container$1 = Container;

exports["default"] = Container$1;
//# sourceMappingURL=index-c83e1edb.js.map
