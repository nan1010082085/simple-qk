(function (global, factory) {
	...
	***************************************************************************** */
	...
	class UseApp {
	  ...
	  constructor({
	    ...
	    if (typeof isLogs === 'boolean' && typeof isLogs !== 'undefined') {
	      ...
	      this.$logs = (config === null || config === void 0 ? void 0 : config.env) === 'dev';
	    }
	  }
	...
	class UseMicroApp {
	  ...
	  start() {
	    if (this.$log) {
	      BrowserLogColor.bgBlack(`[start ${this.$name} app] is primary app :`, window.__POWERED_BY_QIANKUN__);
	      BrowserLogColor.bgGreen(`=============[app info start]`);
	      const table = {
	      ...
	      console.table(table);
	      BrowserLogColor.bgGreen(`=============[app info end]`);
	    }
